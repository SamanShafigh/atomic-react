...
class CommentsModal extends React.Component {
  ...
  render() {
    return (
      <Modal onCancel={this.props.onCancel} isVisible={this.props.isVisible} title="Share an article, photo, video or idea" icon="ic_subject">
        ...
        {this.props.comments.map((comment) => <PostComment comment={comment} />)}
      </Modal>
    )
  }
}
